...
const videoPlayer = () => {
    const videos = [
        ...
        { id: 2, title: 'Video 2', url: 'https://youtu.be/cDYF5xRMHPY?si=wEXMk2XsPa--flwt' },
        ...
        { id: 8, title: 'Video 8', url: 'https://youtu.be/ArOImkUvguI?si=1vJPyI_FccRXOjJY' },
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 px-20 py-16 mt-36">
      {videos.map(video => (
        <div key={video.id} className="p-1 rounded-sm bg-[#FFFFFF]/10 backdrop-blur-md "
        >
